...
router.get('/list',function(request, response){
  fs.readFile('./view/visitbook/list.ejs','utf-8',function(error, data){
...
router.get('/insert', function(request, response){
  if(!request.session.user){
    ...
    fs.readFile('./view/visitbook/insert.ejs', 'utf-8', function(error, data){
...
router.get('/update', function(request, response){
  var idx = request.query.idx;
  fs.readFile('./view/visitbook/update.ejs','utf-8', function(error, data){
